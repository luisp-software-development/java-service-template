# 🧩 Java Service Template — Spring Boot + Docker + Postgres

This project is a **production-style template** I like to use for building modern my Java backend services.
